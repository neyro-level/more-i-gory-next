...
test("header and footer render from site chrome props, not local navigation arrays", () => {
  ...
  const previewNavigationSource = readFileSync("src/components/ui/preview-navigation-menu.tsx", "utf8");
  ...
  assert.match(headerSource, /PreviewNavigationMenu/);
  assert.match(previewNavigationSource, /Все страницы/);
