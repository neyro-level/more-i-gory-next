...
**План:** `MORE_I_GORY_PLAN_№ 3` v3 APPROVED
...
| TASK 49 preview runtime | Выложить exact artifact на project-owned preview после migration/runtime proof существующей DB: HTML/sitemap ранее отдавали bootstrap `503`, `/api/health` был `200` | Nginx/systemd/pack/rollback в EPIC 13; локальный runtime proof PASS | Install-release на Linux preview и browser smoke | нет до RC; да для release |
