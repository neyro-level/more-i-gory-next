...
**Дата проверки:** 2026-09-25 (EPIC 88)
...
| [ADR-014](ADR-014-code-owned-content.md) | Code-owned и Payload-owned content | Accepted | Staging preview читает Payload; seed только local/no-DB и create-missing |
