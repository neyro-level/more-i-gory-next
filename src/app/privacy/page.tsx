...
export default function PrivacyPage() {
  ...
  return (
    <main>
      <SectionShell eyebrow="Юридический документ" title={seo.h1} lead="Юридический текст не опубликован до согласования. Эта страница закрыта от индексации и не заменяет политику конфиденциальности.">
