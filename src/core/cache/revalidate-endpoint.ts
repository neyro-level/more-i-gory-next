...
const tagAllowlist =
  /^(catalog|catalog-slice(?::[a-z0-9-]+)+|complex(?:es|(?::[a-z0-9-]+)+)|developer(?:s|(?::[a-z0-9-]+)+)|navigation|redirects|site-settings|sitemap|page(?::[a-z0-9-]+)*|propert(?:ies|y(?::[a-z0-9-]+)+)|region(?::[a-z0-9-]+)+)$/;
