  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "PII anonymized", value: "pii_anonymized" },
      ],
      required: true,
    },
    ...
    { name: "piiAnonymizedAt", type: "date", index: true },
    { name: "historyPurgeAt", type: "date", index: true },
  ],
  indexes: [
    { fields: ["status", "createdAt"] },
    { fields: ["retentionStatus", "historyPurgeAt"] },
